...
?>
    <main>
        <center id="title_login"><h1 class="display-4">Modifier Un Student</h1></center>
        <div class="container" id="update_container">
            <div class="row">
                <center>
                <div class="col-5 .col-md-4">
                    <div class="p-3 border bg-light">
                    <form id="form1" method="POST" action="assets/UpdateProcess_s.php">
                        <div class="mb-3">
                        ...
                        <button type="submit" class="btn btn-primary" name="update_s" id="btn_sub_reset">Update</button>
                        </form>
                    </div>
                </div>
                </center>
